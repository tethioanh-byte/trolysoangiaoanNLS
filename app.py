...
<div class="main-header">
    ...
    <p>Tác giả: Tề Thị Oanh - Trường Tiểu học Minh Quang - ĐT: 0388702119</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Tề Thị Oanh - Trường Tiểu học Minh Quang - ĐT: 0388702119</div>", unsafe_allow_html=True)
